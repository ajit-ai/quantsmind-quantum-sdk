...
Purpose: A unitary operation contract applicable to one or more Qubits.
...
class Gate(ABC):
    """Abstract contract for gate within the QuantsMind quantum domain."""

    @abstractmethod
    def describe(self) -> dict[str, Any]:
        """Return a structured description of this gate."""
