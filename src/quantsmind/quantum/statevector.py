...
Purpose: A contract for the complex-amplitude representation of quantum State.
...
class Statevector(ABC):
    """Abstract contract for statevector within the QuantsMind quantum domain."""

    @abstractmethod
    def describe(self) -> dict[str, Any]:
        """Return a structured description of this statevector."""
